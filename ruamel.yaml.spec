...
Source0  : https://files.pythonhosted.org/packages/fd/6b/b83bdc8fb9aad62f6469117874e7c11b64d94ba9e8557f73ca1f28c2df7d/ruamel.yaml-0.17.7.tar.gz
...
%prep
%setup -q -n ruamel.yaml-0.17.7
cd %{_builddir}/ruamel.yaml-0.17.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1622563384
...
cp %{_builddir}/ruamel.yaml-0.17.7/LICENSE %{buildroot}/usr/share/package-licenses/ruamel.yaml/626b87d7b11d112fb2e938a309373614f788e1ef
