...
Version  : 0.16.11
Release  : 29
URL      : https://files.pythonhosted.org/packages/a1/ef/41adf2171341744bae1d076961d2fd1ae2150351802c042413dd742c97f7/ruamel.yaml-0.16.11.tar.gz
Source0  : https://files.pythonhosted.org/packages/a1/ef/41adf2171341744bae1d076961d2fd1ae2150351802c042413dd742c97f7/ruamel.yaml-0.16.11.tar.gz
...
%prep
%setup -q -n ruamel.yaml-0.16.11
cd %{_builddir}/ruamel.yaml-0.16.11
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1599166885
...
cp %{_builddir}/ruamel.yaml-0.16.11/LICENSE %{buildroot}/usr/share/package-licenses/ruamel.yaml/c15b57c4797d41f5ba2636d87cfa72bfa99d205f
