...
Source0  : https://files.pythonhosted.org/packages/88/4d/ec3d9d9eca7903c9746976a0157b352c1b1dcb8d9de4590a95f671d44790/ruamel.yaml-0.17.2.tar.gz
...
%prep
%setup -q -n ruamel.yaml-0.17.2
cd %{_builddir}/ruamel.yaml-0.17.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1617037948
...
cp %{_builddir}/ruamel.yaml-0.17.2/LICENSE %{buildroot}/usr/share/package-licenses/ruamel.yaml/626b87d7b11d112fb2e938a309373614f788e1ef
