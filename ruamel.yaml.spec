...
Version  : 0.17.13
Release  : 49
URL      : https://files.pythonhosted.org/packages/3a/d9/62dfe54d52c700151856e4bf192b8d0fec94041ba4097d04c3f3b0b27e50/ruamel.yaml-0.17.13.tar.gz
Source0  : https://files.pythonhosted.org/packages/3a/d9/62dfe54d52c700151856e4bf192b8d0fec94041ba4097d04c3f3b0b27e50/ruamel.yaml-0.17.13.tar.gz
...
%prep
%setup -q -n ruamel.yaml-0.17.13
cd %{_builddir}/ruamel.yaml-0.17.13
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1629743885
...
cp %{_builddir}/ruamel.yaml-0.17.13/LICENSE %{buildroot}/usr/share/package-licenses/ruamel.yaml/626b87d7b11d112fb2e938a309373614f788e1ef
