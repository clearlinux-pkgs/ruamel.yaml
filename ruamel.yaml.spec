...
Source0  : https://files.pythonhosted.org/packages/62/cf/148028462ab88a71046ba0a30780357ae9e07125863ea9ca7808f1ea3798/ruamel.yaml-0.17.4.tar.gz
...
%prep
%setup -q -n ruamel.yaml-0.17.4
cd %{_builddir}/ruamel.yaml-0.17.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1617896998
...
cp %{_builddir}/ruamel.yaml-0.17.4/LICENSE %{buildroot}/usr/share/package-licenses/ruamel.yaml/626b87d7b11d112fb2e938a309373614f788e1ef
