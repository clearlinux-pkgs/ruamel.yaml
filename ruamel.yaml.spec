...
Source0  : https://files.pythonhosted.org/packages/6e/ac/a4c038a2e48a8930a7b04711fec48f779875ed3a3d3941663413454b8fa7/ruamel.yaml-0.17.14.tar.gz
...
%prep
%setup -q -n ruamel.yaml-0.17.14
cd %{_builddir}/ruamel.yaml-0.17.14
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1629931750
...
cp %{_builddir}/ruamel.yaml-0.17.14/LICENSE %{buildroot}/usr/share/package-licenses/ruamel.yaml/626b87d7b11d112fb2e938a309373614f788e1ef
