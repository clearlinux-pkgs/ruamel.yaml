...
Source0  : https://files.pythonhosted.org/packages/4d/15/7fc04de02ca774342800c9adf1a8239703977c49c5deaadec1689ec85506/ruamel.yaml-0.17.17.tar.gz
...
%prep
%setup -q -n ruamel.yaml-0.17.17
cd %{_builddir}/ruamel.yaml-0.17.17
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1635785114
...
cp %{_builddir}/ruamel.yaml-0.17.17/LICENSE %{buildroot}/usr/share/package-licenses/ruamel.yaml/626b87d7b11d112fb2e938a309373614f788e1ef
